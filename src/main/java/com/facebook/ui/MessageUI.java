...
public class MessageUI {
    ...
    public static String getNameFromPathString(String path){
        path=path.replace(Integer.toString(getCurrentUserId()),"");
        path=path.replace("_","");
    ...
    public static void mainPoint() throws IOException {
        System.out.println("Main messenger menu:");
        System.out.println("option 1 = see friends ; option 2 = see chats ; option 3 = see users; option -1 = back ; exit =0");
    ...
    public static void toChooseOrNotToChoose() throws IOException {
    ...
    public static void chatsPoint() throws IOException {
    ...
    public static void inChatPoint(int receiverNr,String filename_path) throws IOException {
